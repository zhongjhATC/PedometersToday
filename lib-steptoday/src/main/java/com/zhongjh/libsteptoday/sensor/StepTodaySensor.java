...
//    private final String TAG = StepTodaySensor.class.getSimpleName();
    ...
    private final Handler sHandler = new Handler(new Handler.Callback() {
        ...
        public boolean handleMessage(@NonNull Message msg) {
            if (msg.what == HANDLER_WHAT_TEST_JLOGGER) {
                Map<String, String> map = new HashMap<>();
                map.put("mCount", String.valueOf(mCount));
                map.put("count", String.valueOf(count));
                map.put("mJLoggerSensorCount", String.valueOf(mJLoggerSensorCount));
                JLoggerWraper.onEventInfo(JLoggerConstant.JLOGGER_TYPE_ACCELEROMETER_TIMER, map);
    ...
    public StepTodaySensor(Context context, OnStepTodayListener onStepTodayListener) {
        super();
        mContext = context;
        ...
        JLoggerWraper.onEventInfo(JLoggerConstant.JLOGGER_TYPE_ACCELEROMETER_CONSTRUCTOR, map);
...
//                "   mTodayDate:" + mTodayDate);
    ...
    private synchronized void dateChangeCleanStep() {
        ...
        if (!getTodayDate().equals(mTodayDate)) {
            ...
            setSteps(0);
            JLoggerWraper.onEventInfo(JLoggerConstant.JLOGGER_TYPE_ACCELEROMETER_DATECHANGECLEANSTEP);
