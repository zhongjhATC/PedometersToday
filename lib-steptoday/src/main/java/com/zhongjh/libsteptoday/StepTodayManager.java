...
public class StepTodayManager {

    public static void startStepTodayService(Application application) {
        try {
            Intent intent = new Intent(application, StepTodayService.class);
